...
public class MessageResponderTextMock implements MessageResponder {
    ...
    public void onMessage(Message message) {
        try {
            if ("Text".equals(message.getStringProperty("Request"))) {
                Message replyMessage = new ActiveMQMessage();
                replyMessage.setJMSCorrelationID(message.getJMSCorrelationID());
                replyMessage.setStringProperty("Text", "sample text");
